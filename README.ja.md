...
```
経理・会計     ████████████████████  8年（freee）
Webマーケ     ████████████████████  SEO: PV 3倍成長（1万→3万）
デザイン       ████████████████░░░░  Illustrator / Photoshop
IT管理         ████████████████░░░░  インフラ / ネットワーク / PC管理
AI / Claude    ████████████████████  Claude Code / n8n / Git
```

## 技術・ツール

![Claude Code](https://img.shields.io/badge/Claude_Code-毎日使用-blueviolet)
![Git](https://img.shields.io/badge/Git-GitHub-black)
![n8n](https://img.shields.io/badge/n8n-ワークフロー自動化-orange)
![TypeScript](https://img.shields.io/badge/TypeScript-学習中-blue)
![AWS](https://img.shields.io/badge/AWS-CLF_学習中-yellow)
